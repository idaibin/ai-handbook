...
| [`skills-forgeway-paired-evaluation-v1/`](./skills-forgeway-paired-evaluation-v1/) | 配对工程评测协议 | 基于 Harbor 与 Multi-SWE-bench 验证 A→B Skills 增益和 B→C Forgeway 增益；Phase 0 尚未执行。 |
