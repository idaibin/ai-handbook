...
All references come from `idaibin/ai-handbook` commit `325c9daeb34df0abaee8f4efa8e715a6f0547887`. Cases 001–006 are claim-preserving, controlled degradations. Cases N01–N04 are untouched negative controls.

## C01 — storage policy (zh, degraded)
...
## C02 — learning source policy (zh, degraded)

Source: `roadmap/learning-path.md`
...
## C03 — LiveKit assessment (zh, degraded)

Source: `research/agents/reports/livekit-agents-02569a4.md`
...
## C04 — Pydantic AI assessment (en, degraded)

Source: `research/agents/reports/pydantic-pydantic-ai-fc6a3ac.md`
...
## C05 — remote verification (zh, degraded)

Source: `sources/coverage/README.md`
...
## C06 — cross-repository findings (en, degraded)

Source: `research/workflows/batches/workflows-deep-20260809T054129Z.md`
...
## N01 — collaboration evidence (zh, negative control)

Source: `maps/codex-configuration-collaboration-map.md`
...
Reference and input are identical:
...
## N02 — source cautions (zh, negative control)
...
## N03 — source evaluation questions (zh, negative control)

Source: `workflows/ai-engineering-system/source-management.md`
...
## N04 — discovery batch process (zh, negative control)

Source: `workflows/repository-research/process.md`
