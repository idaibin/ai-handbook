...
这份索引已写入独立 GitHub review branch 并完成 readback。Drive 只保存项目原始资料和私有证据；不把本地路径、私有 Drive ID、第三方仓库代码或模型权重写入公开索引。当前 commit 由外部 evidence manifest 记录，正文不内嵌自身 commit SHA。
