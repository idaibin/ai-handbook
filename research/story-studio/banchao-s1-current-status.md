...
- `project_id`: `banchao`
- `status_revision`: `1`
- `as_of_utc`: `2026-08-26T01:13:39Z`
...
Mechanical validation performed on `2026-08-26T01:13:39Z` also confirmed:
...
| `EP15→EP16` | `REVIEW_REQUIRED` | `EP15-B08` → `EP16-B01` → `EP16-B02` | EP16-B01/B02 are now independent 1920×1080 RGB PNGs; review character state, diplomatic space, and entry-shot responsibility. |
...
1. This current status;
2. `season-candidate-manifest-current.json`;
3. `season-shot-mapping-current.json`;
4. `banchao-s1-visual-canon-gate-v1.md`;
5. active source contracts:
...
6. current gate evidence and consistency matrix;
7. archived progress, reviews, packages, and historical task documents.
...
| Registry “EP01–EP21 reviewed” | Must be updated to EP01–EP24 / 194-frame final gate |
